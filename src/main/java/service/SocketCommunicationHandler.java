...
//    private IMenuItemService clientService;
...
//        this.clientService = new MenuItemService();
//    }
//
//    /**
...
//            case ADD_CLIENT:
//                try {
//                    MenuItem client = new ObjectMapper().readValue(request.getObj().toString(), MenuItem.class);
...
//            {
//                try {
//                    MenuItemList menuItemList = clientService.getMyPlants();
//                    System.out.println(menuItemList.toString());
////                  JSONObject response = new JSONObject(orders);
//                    String response = new ObjectMapper().writeValueAsString(menuItemList);
//                    send(response);
//                } catch (SQLException | IOException e) {
//                    e.printStackTrace();
//                }
...
//                    MenuItem client = clientService.getPlantById(clientId);
...
//            {
//                try {
//                    MenuItemList menuItemList = clientService.getContractors();
////                  JSONObject response = new JSONObject(orders);
//                    String response = new ObjectMapper().writeValueAsString(menuItemList);
//                    send(response);
//                } catch (SQLException | IOException e) {
...
//            {
//                try {
//                    MenuItemList menuItemList = clientService.getCustomers();
////                  JSONObject response = new JSONObject(orders);
//                    String response = new ObjectMapper().writeValueAsString(menuItemList);
//                    send(response);
